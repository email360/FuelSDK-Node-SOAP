...
FuelSoap.prototype.update = function(type, props, options, callback) {
  ...
  body.UpdateRequest.Objects.forEach(Obj => {
	  Obj.$ = { 'xsi:type': type };
  });
 ...
 * @param {FuelSoap~StandardCallback} callback - Callback that handles response
 */
FuelSoap.prototype.perform = function(type, def, options, callback) {
...
FuelSoap.prototype.extract = function(request, options, callback) {
  var body = {
    PerformExtractMsg: {
      $: {
        xmlns: 'http://exacttarget.com/wsdl/partnerAPI'
